...
- See [this video](https://www.youtube.com/watch?v=lSqUDu4zb5k) and this [slideset](resources/biology-intro-2017.pdf) for some basic introductory material. 
...
- For detailed instructions, refer to [the assignments page](assignments.html#paper-critique-5)
...
- For more detailed instructions, see the [assignments page](assignments.html#analysis-assignment-30) and the [markdown document with the questions](https://github.com/STAT540-UBC/STAT540-UBC.github.io/blob/master/homework/assignment/stat540_analysis_assignment.md)
...
- For detailed grading rubrics of the final project components, see the [final project rubric page](group_project_rubrics.html) and the [final project presentation rubric](homework/ProjectPresentationRubric.pdf)
