...
Virtual office hours: Thursday 11am-12pm (Pacific time)

## Schedule  

Note that as part of UBC's response to the COVID-19 omicron variant, lecture and seminar will be held online for the first part of the term (synchronously via Zoom; meeting links posted in Canvas). It is expected that lecture and seminar will be held in person starting February 7. In case of any changes to this plan, stay tuned to [UBC Broadcast communications](https://covid19.ubc.ca/).
...
- Location: 
    * *Before Februrary 7*: online (Zoom meeting links posted in Canvas)
    * *On February 7 and after*: in person in [ESB 2012](https://ssc.adm.ubc.ca/classroomservices/function/viewlocation?userEvent=ShowLocation&buildingID=ESB&roomID=2012) 
...
- Time : Mon 12pm - 1pm
- Location: 
    * *Before February 7*: online (Zoom meeting links posted in Canvas)
    * *On February 7 and after*: in person in [ESB 1012](https://ssc.adm.ubc.ca/classroomservices/function/viewlocation?userEvent=ShowLocation&buildingID=ESB&roomID=1012)
