...
- If your data is small enough, create a read only subdirectory called `data` and keep your data there
...
- Make sure your code is readable, documented, and could be run by instructors. Make sure you are addressing the important files, such as "inputs" (e.g. the dataset(s) you analyzed) and "outputs" (e.g. figures). Provide valid links for the files you use in your scripts. Link to the report in your main README file.
