...
## Individual assignments
  ...
  * Use the repositories that are generated for you when you accept each assignment (e.g., the repo with the format `STAT540-UBC-2022/seminar-01-yourGitHubID` will contain your Seminar 1 deliverable). Do not use additional branches or any other repositories to submit your course work.
